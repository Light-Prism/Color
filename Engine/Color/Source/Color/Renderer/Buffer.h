...
namespace Color
{
	...
	public:
		...
		static Ref<VertexBuffer> New(uint32_t size);
		static Ref<VertexBuffer> New(const float* vertices, uint32_t size);
	};
	...
	public:
		...
		static Ref<IndexBuffer> New(const uint32_t* indices, uint32_t count);
	};
}
